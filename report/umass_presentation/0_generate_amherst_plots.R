...
nood_plot <- ggplot(data = prop_total_deaths, 
    ...
    geom_hline(yintercept = 3, color = "grey50", size = .5) + 
    ...
    mk_whites(legend.position = "none", 
              plot.margin = unit(c(0.35, 4, 0.3, 0.35), "cm")) + 
...
ggsave(nood_plot, filename = "./report/umass_presentation/plots/fig1_nood_v_ci.pdf", 
       height = 5.5, width = 8, scale = 1, device = cairo_pdf)
...
ggsave(adj_overall_ci_v, 
       filename = './report/umass_presentation/plots/fig2_overall_adjusted_ci_v.pdf', 
       height = 4, width = 4, scale = 1, device = cairo_pdf)
...
rel_adj_overall <- ggplot(data = rel_adj_deaths_overall, 
    ...
    geom_hline(yintercept = min(rel_adj_deaths_overall$relrisk), 
               color = "grey50", size = .5) + 
    geom_line(size = 1, alpha = .9) + 
...
ggsave(rel_adj_overall_ci_v, 
       filename = './report/umass_presentation/plots/fig2_relative_risk_ci_v.pdf', 
       height = 4, width = 4, scale = 1, device = cairo_pdf)
...
ggsave(adj_ucod_ci_v, 
       filename = './report/umass_presentation/plots/fig3_ucod_adjusted_ci_v.pdf',
       height = 4, width = 8, scale = 1, device = cairo_pdf)
...
ggsave(t4_adj_plots_race_lines_v_ci, 
       filename = './report/umass_presentation/plots/fig4_t40_adjusted_race_lines_v_ci.pdf', 
       height = 4, width = 8, scale = 1, device = cairo_pdf)
...
ggsave(asmr_by_race_2_f_w, 
       filename = "./report/umass_presentation/plots/fig5_asmr_race_all_errorbars.pdf", 
...
ggsave(age_t40_3_ci, 
       filename = './report/umass_presentation/plots/fig7_t40_notpretty_ci.pdf', 
...
ggsave(age_t40_3h_ci, 
       filename = './report/umass_presentation/plots/fig7_t40_heroin_ci.pdf', 
       width = 8, height = 4, scale = 1.25, device = cairo_pdf)
...
ggsave(p_ma_2_or_more_ci_v, 
       filename =  "./report/umass_presentation/plots/fig8_prop_2_more_ci_v.pdf", 
       height = 4, width = 6, scale = 1.1, device = cairo_pdf)
...
ggsave(p_ma_t401_combo_v, 
       filename =  "./report/umass_presentation/plots/fig9_t401_combos_v_ci.pdf", 
       height = 4, width = 8, scale = 1.1, device = cairo_pdf)
